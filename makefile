...
SUBDIRS := heredocs signals ast dict expand exec/pipeline lex readline banner
...
SRCS := $(SRC_MAIN) $(SRC_AST) $(SRC_SIGN) $(SRC_HERE) $(SRC_DICT) $(SRC_EXP) $(SRC_BANNER) $(SRC_EXEC_P) $(SRC_LEX) $(SRC_RL) $(SRC_PRINT)
